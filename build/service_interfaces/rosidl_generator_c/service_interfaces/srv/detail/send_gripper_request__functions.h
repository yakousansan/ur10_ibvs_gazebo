...
#ifndef SERVICE_INTERFACES__SRV__DETAIL__SEND_GRIPPER_REQUEST__FUNCTIONS_H_
#define SERVICE_INTERFACES__SRV__DETAIL__SEND_GRIPPER_REQUEST__FUNCTIONS_H_
...
/// Initialize srv/SendGripperRequest message.
/**
...
/// Finalize srv/SendGripperRequest message.
/**
...
/// Create srv/SendGripperRequest message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * service_interfaces__srv__SendGripperRequest_Request__init().
...
/// Destroy srv/SendGripperRequest message.
/**
 * It calls
 * service_interfaces__srv__SendGripperRequest_Request__fini()
...
/// Check for srv/SendGripperRequest message equality.
/**
...
/// Copy a srv/SendGripperRequest message.
/**
...
/// Initialize array of srv/SendGripperRequest messages.
/**
...
/// Finalize array of srv/SendGripperRequest messages.
/**
 * It calls
 * service_interfaces__srv__SendGripperRequest_Request__fini()
...
/// Create array of srv/SendGripperRequest messages.
/**
 * It allocates the memory for the array and calls
 * service_interfaces__srv__SendGripperRequest_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SendGripperRequest messages.
/**
 * It calls
 * service_interfaces__srv__SendGripperRequest_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SendGripperRequest message array equality.
/**
...
/// Copy an array of srv/SendGripperRequest messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * service_interfaces__srv__SendGripperRequest_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_service_interfaces
...
/**
 * It calls
 * service_interfaces__srv__SendGripperRequest_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_service_interfaces
...
/**
 * It allocates the memory for the array and calls
 * service_interfaces__srv__SendGripperRequest_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_service_interfaces
...
/**
 * It calls
 * service_interfaces__srv__SendGripperRequest_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SERVICE_INTERFACES__SRV__DETAIL__SEND_GRIPPER_REQUEST__FUNCTIONS_H_
