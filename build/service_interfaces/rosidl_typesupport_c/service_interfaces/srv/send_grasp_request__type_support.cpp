...
static const _SendGraspRequest_Request_type_support_symbol_names_t _SendGraspRequest_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, service_interfaces, srv, SendGraspRequest_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_interfaces, srv, SendGraspRequest_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, service_interfaces, srv, SendGraspRequest_Request)() {
  return &::service_interfaces::srv::rosidl_typesupport_c::SendGraspRequest_Request_message_type_support_handle;
}
...
static const _SendGraspRequest_Response_type_support_symbol_names_t _SendGraspRequest_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, service_interfaces, srv, SendGraspRequest_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_interfaces, srv, SendGraspRequest_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, service_interfaces, srv, SendGraspRequest_Response)() {
  return &::service_interfaces::srv::rosidl_typesupport_c::SendGraspRequest_Response_message_type_support_handle;
}
...
static const _SendGraspRequest_type_support_symbol_names_t _SendGraspRequest_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, service_interfaces, srv, SendGraspRequest)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_interfaces, srv, SendGraspRequest)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, service_interfaces, srv, SendGraspRequest)() {
  return &::service_interfaces::srv::rosidl_typesupport_c::SendGraspRequest_service_type_support_handle;
}
